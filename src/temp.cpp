...
//                         if ( mixture[i_bdr][j_bdr][k_bdr].type == TYPE_O_C){
//                             double sigma = 0.25;
...
//                                 double dp_dx    = fd_uw2(mixture[i][j][k].p     , mixture[i_1][j_1][k_1].p  , mixture[i_2][j_2][k_2].p  , dy, cy[l_interface]) ;
//                                 double du_dx    = fd_uw2(mixture[i][j][k].u     , mixture[i_1][j_1][k_1].u  , mixture[i_2][j_2][k_2].u  , dy, cy[l_interface]) ;
//                                 double dv_dx    = fd_uw2(mixture[i][j][k].v     , mixture[i_1][j_1][k_1].v  , mixture[i_2][j_2][k_2].v  , dy, cy[l_interface]) ;
//                                 double dw_dx    = fd_uw2(mixture[i][j][k].w     , mixture[i_1][j_1][k_1].w  , mixture[i_2][j_2][k_2].w  , dy, cy[l_interface]) ;
//                                 double drho_dx  = fd_uw2(mixture[i][j][k].rho   , mixture[i_1][j_1][k_1].rho, mixture[i_2][j_2][k_2].rho, dy, cy[l_interface]) ;
//                                 double dYa_dx[nSpecies] = {0.0};
//                                 for (size_t a = 0; a < nSpecies; ++a)
//                                      dYa_dx[a] = fd_uw2(species[a][i][j][k].rho/mixture[i][j][k].rho, species[a][i_1][j_1][k_1].rho/mixture[i_1][j_1][k_1].rho, species[a][i_2][j_2][k_2].rho/mixture[i_2][j_2][k_2].rho, dy, cy[l_interface]) ;
...
//                                 double dp_dx    = fd_uw2(mixture[i][j][k].p     , mixture[i_1][j_1][k_1].p  , mixture[i_2][j_2][k_2].p  , dz, cz[l_interface]) ;
//                                 double du_dx    = fd_uw2(mixture[i][j][k].u     , mixture[i_1][j_1][k_1].u  , mixture[i_2][j_2][k_2].u  , dz, cz[l_interface]) ;
//                                 double dv_dx    = fd_uw2(mixture[i][j][k].v     , mixture[i_1][j_1][k_1].v  , mixture[i_2][j_2][k_2].v  , dz, cz[l_interface]) ;
//                                 double dw_dx    = fd_uw2(mixture[i][j][k].w     , mixture[i_1][j_1][k_1].w  , mixture[i_2][j_2][k_2].w  , dz, cz[l_interface]) ;
//                                 double drho_dx  = fd_uw2(mixture[i][j][k].rho   , mixture[i_1][j_1][k_1].rho, mixture[i_2][j_2][k_2].rho, dz, cz[l_interface]) ;
//                                 double dYa_dx[nSpecies] = {0.0};
//                                 for (size_t a = 0; a < nSpecies; ++a)
//                                      dYa_dx[a] = fd_uw2(species[a][i][j][k].rho/mixture[i][j][k].rho, species[a][i_1][j_1][k_1].rho/mixture[i_1][j_1][k_1].rho, species[a][i_2][j_2][k_2].rho/mixture[i_2][j_2][k_2].rho, dz, cz[l_interface]) ;
...
//                                 double relax_K = sigma*spd_sound*(1.0 - (mixture[i][j][k].w/spd_sound)*(mixture[i][j][k].w/spd_sound))/Nx;

//                                 if(cz[l_interface] > 0) // left boundary
//                                     L5 = relax_K * ( mixture[i][j][k].p -  mixture[i_bdr][j_bdr][k_bdr].p);
//                                 else // right boundary
//                                     L1 = relax_K * ( mixture[i][j][k].p -  mixture[i_bdr][j_bdr][k_bdr].p);
...
//                         if ( mixture[i_bdr][j_bdr][k_bdr].type == TYPE_I_C){
//                             double eta = 10.0; // damping coefficient for imposing inlet properties
...
//                                 double L1 = lambda_1*(dp_dx - mixture[i][j][k].rho*spd_sound*du_dx);
//                                 double L2 = -eta*mixture[i][j][k].rho*units.cp(Cantera::GasConstant/gas->meanMolecularWeight())*(mixture[i][j][k].temp - mixture[i_bdr][j_bdr][k_bdr].temp) * spd_sound/Nx;
//                                 double L3 = eta*(mixture[i][j][k].v - mixture[i_bdr][j_bdr][k_bdr].v) * spd_sound/Nx;
//                                 double L4 = eta*(mixture[i][j][k].w - mixture[i_bdr][j_bdr][k_bdr].w) * spd_sound/Nx;
//                                 double L5 = lambda_5*(dp_dx + mixture[i][j][k].rho*spd_sound*du_dx);
//                                 double L6[nSpecies] = {0.0};
//                                 for(size_t a = 0; a < nSpecies; ++a)
//                                     L6[a] = eta*(species[a][i][j][k].rho - species[a][i_bdr][j_bdr][k_bdr].rho) * spd_sound/Nx;

//                                 if(cx[l_interface] > 0) // left boundary
//                                     L5 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].u/spd_sound)*(mixture[i][j][k].u/spd_sound) )) / Nx * (mixture[i][j][k].u - mixture[i_bdr][j_bdr][k_bdr].u);
//                                 else // right boundary
//                                     L1 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].u/spd_sound)*(mixture[i][j][k].u/spd_sound) )) / Nx * (mixture[i][j][k].u - mixture[i_bdr][j_bdr][k_bdr].u);
...
//                                 double d4 = L4;
//                                 double d5 = 0.5*(L5+L1);
//                                 double d6[nSpecies] = {0.0};
//                                 for(size_t a = 0; a < nSpecies; ++a)
//                                     d6[a] = L6[a];

//                                 rho_in    = mixture[i][j][k].rho - dt_sim*d1; //mixture[i_bdr][j_bdr][k_bdr].rho ;
//                                 vel_in[0] = mixture[i][j][k].u - dt_sim*d2;   //mixture[i_bdr][j_bdr][k_bdr].u   ;
//                                 vel_in[1] = mixture[i][j][k].v - dt_sim*d3;   //mixture[i_bdr][j_bdr][k_bdr].v   ;
//                                 vel_in[2] = mixture[i][j][k].w - dt_sim*d4;   //mixture[i_bdr][j_bdr][k_bdr].w   ; 
//                                 p_in      = mixture[i][j][k].p - dt_sim*d5; // mixture[i_1][j_1][k_1].p   ;
//                                 for(size_t a = 0; a < nSpecies; ++a){
//                                     rhoa_in[a] = (species[a][i][j][k].rho - dt_sim*d6[a]) ;// species[a][i_bdr][j_bdr][k_bdr].rho;  //species[a][i][j][k].rho - dt_sim*d6[a];//
//                                     rho_in = rho_in - dt_sim*d6[a];
//                                 }
//                             }
//                             else if (cy[l_interface] != 0.0){
//                                 double lambda_1 = mixture[i][j][k].v - spd_sound;
...
//                                 double L1 = lambda_1*(dp_dx - mixture[i][j][k].rho*spd_sound*dv_dx);
//                                 double L2 = -eta*mixture[i][j][k].rho*units.cp(Cantera::GasConstant/gas->meanMolecularWeight())*(mixture[i][j][k].temp - mixture[i_bdr][j_bdr][k_bdr].temp) * spd_sound/Ny;
//                                 double L3 = eta*(mixture[i][j][k].w - mixture[i_bdr][j_bdr][k_bdr].w) * spd_sound/Ny;
//                                 double L4 = eta*(mixture[i][j][k].u - mixture[i_bdr][j_bdr][k_bdr].u) * spd_sound/Ny;
//                                 double L5 = lambda_5*(dp_dx + mixture[i][j][k].rho*spd_sound*dv_dx);
//                                 double L6[nSpecies] = {0.0};
//                                 for(size_t a = 0; a < nSpecies; ++a)
//                                     L6[a] = eta*(species[a][i][j][k].rho - species[a][i_bdr][j_bdr][k_bdr].rho) * spd_sound/Ny;

//                                 if(cx[l_interface] > 0) // left boundary
//                                     L5 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].v/spd_sound)*(mixture[i][j][k].v/spd_sound) )) / Ny * (mixture[i][j][k].v - mixture[i_bdr][j_bdr][k_bdr].v);
//                                 else // right boundary
//                                     L1 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].v/spd_sound)*(mixture[i][j][k].v/spd_sound) )) / Ny * (mixture[i][j][k].v - mixture[i_bdr][j_bdr][k_bdr].v);
...
//                                 double L1 = lambda_1*(dp_dx - mixture[i][j][k].rho*spd_sound*dw_dx);
//                                 double L2 = -eta*mixture[i][j][k].rho*units.cp(Cantera::GasConstant/gas->meanMolecularWeight())*(mixture[i][j][k].temp - mixture[i_bdr][j_bdr][k_bdr].temp) * spd_sound/Nz;
//                                 double L3 = eta*(mixture[i][j][k].u - mixture[i_bdr][j_bdr][k_bdr].u) * spd_sound/Nz;
//                                 double L4 = eta*(mixture[i][j][k].v - mixture[i_bdr][j_bdr][k_bdr].v) * spd_sound/Nz;
//                                 double L5 = lambda_5*(dp_dx + mixture[i][j][k].rho*spd_sound*dw_dx);
//                                 double L6[nSpecies] = {0.0};
//                                 for(size_t a = 0; a < nSpecies; ++a)
//                                     L6[a] = eta*(species[a][i][j][k].rho - species[a][i_bdr][j_bdr][k_bdr].rho) * spd_sound/Ny;
...
//                                 if(cx[l_interface] > 0) // left boundary
//                                     L5 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].w/spd_sound)*(mixture[i][j][k].w/spd_sound) )) / Nz * (mixture[i][j][k].w - mixture[i_bdr][j_bdr][k_bdr].w);
//                                 else // right boundary
//                                     L1 = eta*(mixture[i][j][k].rho*spd_sound*spd_sound*( 1.0-(mixture[i][j][k].w/spd_sound)*(mixture[i][j][k].w/spd_sound) )) / Nz * (mixture[i][j][k].w - mixture[i_bdr][j_bdr][k_bdr].w);
